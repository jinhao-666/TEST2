...
public class RegisterFrame extends JFrame {
	...
	public void init(){
		this.setTitle("注册Happy Fly Bird社区新账号");//设置标题
		...
		ImageIcon iconbg = new ImageIcon("src/images/bg2.jpg");
		...
		for (int i = 0; i < 11; i++) {
			head.addItem(new ImageIcon("src/images/" + i + ".png"));
	...
	private void registe(User user) throws IOException, ClassNotFoundException{
		...
		//获取响应
		ResponseStatus.Response response = ClientUtil.sendTextRequest(request);
