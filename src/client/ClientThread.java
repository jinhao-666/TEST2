...
public class ClientThread extends Thread {
	...
	public void run() {
		try {
			while (DataBuffer.clientSeocket.isConnected()) {
				ResponseStatus.Response response = (ResponseStatus.Response) DataBuffer.ois.readObject();
	...
	/** 发送文件 */
	private void sendFile(ResponseStatus.Response response) {
	...
	/** 接收文件 */
	private void receiveFile(ResponseStatus.Response response) {
		final FileInfo sendFile = (FileInfo)response.getData("sendFile");
	...
	/** 准备发送文件	 */
	private void toSendFile(ResponseStatus.Response response) {
